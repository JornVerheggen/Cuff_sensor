...
class TestModule(unittest.TestCase):
    ...
    def test_singleTranslationInZDirection(self):
        solver = Solver()

        s1Val = np.array([-3,0,10])
        s2Val = np.array([-3,0,10])
        s3Val = np.array([-3,0,10])
        ...
        np.testing.assert_array_almost_equal(vs1m1,np.array([-10,0,3]))
        np.testing.assert_array_almost_equal(vs2m2,np.array([5,-8.660254,3]))
        np.testing.assert_array_almost_equal(vs3m3,np.array([5, 8.660254,3]))
        ...
        np.testing.assert_array_almost_equal(m1Pos,np.array([-47, 0, 3*1.28]))
        np.testing.assert_array_almost_equal(m2Pos,np.array([23.5,-40.7031939,3*1.28]))
        np.testing.assert_array_almost_equal(m3Pos,np.array([23.5, 40.7031939,3*1.28]))

        outerPos = solver.getTranslation(m1Pos,m2Pos,m3Pos)

        np.testing.assert_array_almost_equal(outerPos,np.array([0,0,3*1.28]))
